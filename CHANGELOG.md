...
- Return keys of normalized object used during denormalization in `keys` props in denormalize() result. See [#30](https://github.com/dividab/graphql-norm/pull/30) and PR [#36](https://github.com/dividab/graphql-norm/pull/36).
